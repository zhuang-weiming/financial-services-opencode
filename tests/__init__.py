...
PYTHON_PKG = OPENCODE_DIR / "python" / "vibe-trading"
...
ROUTING_TABLE = {
    ...
    # --- ai-hedge-fund investor personas (2026-09-10) ---
    # --- 趋势分析 (10 算法) ---
    "趋势分析": ["alpha-researcher"],
    "技术分析": ["alpha-researcher"],
    "走势判断": ["alpha-researcher"],
    "形态分析": ["alpha-researcher"],
    "波浪分析": ["alpha-researcher"],
    "缠论": ["alpha-researcher"],
    "蜡烛图": ["alpha-researcher"],
    "支撑压力": ["alpha-researcher"],
    "支撑位": ["alpha-researcher"],
    "压力位": ["alpha-researcher"],
    "江恩": ["alpha-researcher"],
    "一目均衡": ["alpha-researcher"],
    "艾略特": ["alpha-researcher"],
    "谐波": ["alpha-researcher"],
    "trend analysis": ["alpha-researcher"],
    "该不该买": ["alpha-researcher", "wealth-management"],
    "该不该卖": ["alpha-researcher", "wealth-management"],
    # --- 非价格证据 (4 维度) ---
    "非价格证据": ["factor-researcher"],
    "成交量结构": ["factor-researcher"],
    "资金流向": ["factor-researcher", "market-router"],
    "龙虎榜": ["market-router"],
    "两融": ["market-router"],
    "融资融券": ["market-router"],
    "北向": ["market-router"],
    ...
    "限售解禁": ["market-router"],
    "内部人交易": ["market-router"],
    "insider": ["market-router"],
    "13f": ["market-router"],
    "机构持仓": ["market-router"],
    # --- 三层组合触发 (价格层 + 独立证据层 + 基本面层) ---
    "综合分析": ["equity-research", "alpha-researcher"],
    "全栈分析": ["equity-research", "alpha-researcher"],
    "三层分析": ["equity-research", "alpha-researcher"],
    "投资大佬 + 趋势": ["equity-research", "alpha-researcher"],
    "趋势 + 大佬": ["equity-research", "alpha-researcher"],
    "这家公司怎么样": ["equity-research", "alpha-researcher"],
    "全方位分析": ["equity-research", "alpha-researcher"],
    # --- "投资大佬" 聚合触发 (路由到全部 persona) ---
    "投资大佬": ["equity-research", "swarm-orchestrator"],
    "各位大佬": ["equity-research", "swarm-orchestrator"],
    "大佬们": ["equity-research", "swarm-orchestrator"],
    "投资大师": ["equity-research", "swarm-orchestrator"],
    "大师们": ["equity-research", "swarm-orchestrator"],
    "投资人视角": ["equity-research", "swarm-orchestrator"],
    "各位投资人": ["equity-research", "swarm-orchestrator"],
    "多视角分析": ["equity-research", "swarm-orchestrator"],
    "gurus": ["equity-research", "swarm-orchestrator"],
    "investor lenses": ["equity-research", "swarm-orchestrator"],
    "ai-hedge-fund": ["equity-research", "swarm-orchestrator"],
    "ai hedge fund": ["equity-research", "swarm-orchestrator"],
    "aihf": ["equity-research", "swarm-orchestrator"],
    "多智能体对冲基金": ["equity-research", "swarm-orchestrator"],
    "fund mandate": ["equity-research", "swarm-orchestrator"],
    "desk 模拟": ["equity-research", "swarm-orchestrator"],
    "巴菲特": ["equity-research"],
    "buffett": ["equity-research"],
    "buffett lens": ["equity-research"],
    "巴菲特视角": ["equity-research"],
    "巴菲特会怎么看": ["equity-research"],
    "护城河": ["equity-research"],
    "芒格": ["equity-research"],
    "munger": ["equity-research"],
    "munger lens": ["equity-research"],
    "芒格视角": ["equity-research"],
    "芒格会怎么看": ["equity-research"],
    "太难堆": ["equity-research"],
    "格雷厄姆": ["equity-research", "financial-analysis"],
    "graham": ["equity-research", "financial-analysis"],
    "graham lens": ["equity-research", "financial-analysis"],
    "格雷厄姆视角": ["equity-research", "financial-analysis"],
    "安全边际": ["equity-research", "financial-analysis"],
    "防御型投资": ["equity-research", "financial-analysis"],
    "林奇": ["equity-research"],
    "lynch": ["equity-research"],
    "lynch lens": ["equity-research"],
    "林奇视角": ["equity-research"],
    "peg": ["equity-research"],
    "德鲁肯米勒": ["equity-research", "factor-researcher"],
    "druckenmiller": ["equity-research", "factor-researcher"],
    "druckenmiller lens": ["equity-research", "factor-researcher"],
    "德鲁肯米勒视角": ["equity-research", "factor-researcher"],
    "不对称下注": ["equity-research", "factor-researcher"],
    "deep value": ["equity-research", "financial-analysis"],
    "深度价值": ["equity-research", "financial-analysis"],
    "深度价值策略": ["equity-research", "financial-analysis"],
    "安全边际组合": ["equity-research", "financial-analysis"],
    "earnings drift": ["earnings-reviewer", "factor-researcher"],
    "pead": ["earnings-reviewer", "factor-researcher"],
    "财报后漂移": ["earnings-reviewer", "factor-researcher"],
    "盈利意外": ["earnings-reviewer", "factor-researcher"],
    "fundamental long short": ["equity-research", "swarm-orchestrator"],
    "fundamental ls": ["equity-research", "swarm-orchestrator"],
    "市场中性": ["equity-research", "swarm-orchestrator"],
    "多空组合": ["equity-research", "swarm-orchestrator"],
    "基本面多空": ["equity-research", "swarm-orchestrator"],
    "inflections": ["equity-research", "factor-researcher"],
    "拐点策略": ["equity-research", "factor-researcher"],
    "拐点 mandate": ["equity-research", "factor-researcher"],
    "基本面加速": ["equity-research", "factor-researcher"],
    "变化率交易": ["equity-research", "factor-researcher"],
}
