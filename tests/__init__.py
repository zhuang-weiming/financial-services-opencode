...
ROUTING_TABLE = {
    ...
    "identify which market": ["market-router"],
    "宣布收购": ["investment-banking"],
    "strategy on the": ["backtest-builder"],
    "穿越市场周期": ["wealth-management"],
    "市场晨会简报": ["swarm-orchestrator"],
    "跨市场分析师": ["swarm-orchestrator"],
    "投资委员会": ["swarm-orchestrator"],
    "估值合理性": ["valuation-reviewer"],
    "核心-卫星": ["wealth-management", "pitch-agent"],
    "足球场视图": ["pitch-agent", "financial-analysis"],
    "适当性检查": ["kyc-screener"],
    "合规要求": ["kyc-screener"],
    "行业轮动": ["market-researcher"],
    "投资趋势": ["market-researcher"],
    "板块配置": ["market-researcher"],
    "智能投顾": ["operations"],
    "量化方法": ["operations"],
    "现金流影响分析": ["financial-analysis"],
    "全面诊断": ["wealth-management"],
    "行为偏误": ["wealth-management"],
    "因子暴露": ["factor-researcher"],
    "因子相关性": ["factor-researcher"],
    "多因子": ["alpha-researcher", "factor-researcher"],
    "因子投资": ["alpha-researcher", "factor-researcher"],
    "量化投资": ["alpha-researcher", "factor-researcher"],
    "另类资产": ["private-equity"],
    "跟投": ["private-equity"],
    "并购": ["investment-banking"],
    "首次覆盖": ["market-researcher", "equity-research"],
    "催化剂日历": ["market-researcher", "equity-research"],
    "三表模型": ["model-builder"],
    "持仓报表": ["statement-auditor"],
    "审计意见": ["statement-auditor"],
    "持仓记录": ["gl-reconciler"],
    "到账": ["gl-reconciler"],
    "费用结构": ["fund-admin"],
    "nav 报告": ["fund-admin", "statement-auditor"],
    "关账": ["month-end-closer"],
    "权责发生制": ["month-end-closer", "fund-admin"],
    "投后回顾": ["meeting-prep-agent"],
    "对比分析": ["meeting-prep-agent"],
    "互斥交易": ["pitch-agent"],
    "选股逻辑": ["backtest-builder"],
    "验证策略": ["backtest-builder"],
    "财报": ["earnings-reviewer"],
    "跨市场": ["market-router"],
    "dcf 模型": ["model-builder", "financial-analysis"],
    "压力测试": ["valuation-reviewer"],
