---
name: vibe-trading-correlation-regime
...
The `vibe-trading-correlation-analysis` skill answers *"how correlated are these assets?"* — a snapshot.
...
- For static pair analysis, cointegration, and pair-trading signals, see the
  `vibe-trading-correlation-analysis` skill; for volatility-based regime work, see `vibe-trading-volatility`.
