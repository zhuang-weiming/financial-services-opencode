---
name: vibe-trading-valuation-model
...
6. **Not suitable for cryptocurrencies**: traditional valuation frameworks do not apply to BTC / ETH; use on-chain metrics instead (see `vibe-trading-onchain-analysis`)
