---
name: vibe-trading-multi-factor
...
Cross-references:
- See the `vibe-trading-alpha-zoo` skill for browsing the alpha catalogue, filtering by `theme`/`universe`, and inspecting `__alpha_meta__` records.
