---
name: vibe-trading-credit-analysis
...
> 可转债的转股期权部分详见 `vibe-trading-convertible-bond` skill，本节聚焦纯债价值。
...
| 相关 Skill | 互补关系 |
|------------|----------|
| `vibe-trading-convertible-bond` | 可转债转股期权部分由 convertible-bond skill 处理，本 skill 负责纯债定价和信用风险 |
| `vibe-trading-macro-analysis` | 宏观利率环境和信用周期判断由 macro skill 提供输入 |
