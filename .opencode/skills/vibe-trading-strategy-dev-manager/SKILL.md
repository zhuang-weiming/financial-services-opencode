---
name: vibe-trading-strategy-dev-manager
...
2. Classify the paper type:
   - **vibe-trading-factor-research**: the paper proposes one or more cross-sectional factors with formulas (for example Jegadeesh and Titman 1993, Fama-French 1993)
