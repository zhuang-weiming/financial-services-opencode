...
**核心框架纪律：** 用户的研究问题本质与 `personal-system/3.US_FRAMEWORK.md` 中的 HYP-027/028/029（化债双剧本 + 全球同步货币化）直接相关。研究产出**不预设观点**，但若发现与活跃 HYP 矛盾的事实会明示标注。
...
| 中国化债（2023-2027） | 2023-至今 | 地方政府债务互换 | **行政命令** | 进行中（用户在 3.1.CHINA_FRAMEWORK.md 已分析） |
...
## 6. 与现有 HYP 的关联（来自 personal-system/3.US_FRAMEWORK.md）
...
> 3.US_FRAMEWORK.md §1.3 中"主动快速剧本已被 HYP-020/026 证伪" 的结论**被本研究进一步强化** —— AI 不能解决"无受益人联盟"问题。
