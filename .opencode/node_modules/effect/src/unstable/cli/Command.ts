...
export const annotate: {
   ...
   * @category combinators
   */
  <I, S>(service: Context.Key<I, S>, value: NoInfer<S>): <Name extends string, Input, E, R, ContextInput>(
    self: Command<Name, Input, ContextInput, E, R>
  ) => Command<Name, Input, ContextInput, E, R>
  /**
   * Adds a custom annotation to a command.
...
export const annotateMerge: {
   ...
   * @category combinators
   */
  <I>(annotations: Context.Context<I>): <Name extends string, Input, E, R, ContextInput>(
    self: Command<Name, Input, ContextInput, E, R>
  ) => Command<Name, Input, ContextInput, E, R>
  /**
   * Merges a Context of annotations into a command.
...
export const provideSync: {
   ...
   * @category providing services
   */
  <I, S, Input>(service: Context.Key<I, S>, implementation: S | ((input: Input) => S)): <const Name extends string, E, R, ContextInput>(
    self: Command<Name, Input, ContextInput, E, R>
